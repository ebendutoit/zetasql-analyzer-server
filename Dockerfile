...
RUN cd /work/zetasql/proto \
  && ls -l \
  && protoc -I=/work/zetasql/public/builtin_function.proto -I=/work/zetasql/public/options.proto -I=/work/zetasql/public/type.proto -I=/work/zetasql/resolved_ast/resolved_node_kind.proto.template --cpp_out=. ./options.proto
