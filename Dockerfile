...
RUN cd /work/zetasql/proto \
  && ls -l \
  && protoc -I=/work/zetasql/ -I=/work/zetasql/public/builtin_function.proto -I=zetasql/public/options.proto --cpp_out=/work/zetasql/proto/ /work/zetasql/proto/options.proto
