...
# Protobuf
RUN cd /tmp && git clone https://github.com/protocolbuffers/protobuf protobuf && ls -la && mkdir /work/google && cp -R protobuf /work/google/protobuf && ls /work/ && ls /work/google
